...
public class SwaggerConfig {
	...
	public static final Contact DEFAULT_CONTACT = new Contact("Tushar Arora", "http://tushar.com", "tusharrguliany@gmail.com");
	public static final ApiInfo DEFAULT_API_INFO = new ApiInfo("SocialZilla APIs", "SocialZilla API Documentation", "1.0",
